...
- `TOOLS_RLM.md` — `run_python` tool-call template with injected Python preamble
- `TOOLS_RLM_INLINE.md` — no-tools `<run_python>` instructions with injected Python preamble
